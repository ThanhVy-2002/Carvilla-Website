...
export const Service: React.FC = () => {
    ...
    return <>
        <div className="w-[800px] h-[220px] shrink-0 rounded-[5px] bg-white shadow-lg flex flex-row space-x-[20px] -translate-y-[360px] translate-x-[250px]">
        ...
        <div className="flex flex-nowrap space-x-4 translate-x-[280px] -translate-y-[250px]">
            {data.map((item: any) => (
                <div className="border w-[230px] h-[200px] shrink-0 rounded-[5px] bg-white shadow-lg hover:bg-[#4f46e5] hover:text-white">
